...
const Cardd = () => {
  return (
    <div className="relative flex w-72 h-80 flex-col overflow-hidden rounded-xl bg-primary bg-clip-border text-gray-900 border-gray-900 border-2 shadow-lg">
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="py-2 justify-end items-end ml-32">
            <button className="underline text-sm text-right text-yellow-500">CONTACT</button>
        </div>
      </div>
    </div>
  );
